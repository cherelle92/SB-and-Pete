...
my_girl = Movie.create(title: 'My Girl', description: "Vada, a hypochondriac, becomes distraught when her father, a widower, begins dating Shelly, a makeup artist, and attempts to disrupt their relationship.")
coco = Movie.create(title: 'Coco', description: "Miguel pursues his love for singing in spite of his family's ban on music. He stumbles into the Land of the Dead, where he learns about his great-great-grandfather who was a legendary singer.")
schindler = Movie.create(title: "Schindler's List", description: "Oskar Schindler, a German industrialist and member of the Nazi party, tries to save his Jewish employees after witnessing the persecution of Jews in Poland.")
little_miss_sunshine = Movie.create(title: 'Little Miss Sunshine', description:"A family decide to travel across the country when their daughter wants to participate in a beauty pageant, unaware of what the journey has in store for them.")
legally_blonde = Movie.create(title: 'Legally Blonde', description: "Elle's boyfriend breaks up with her for a smarter girl as he plans to become a politician and joins Harward law school. Elle gets enrolled in the same school in an effort to teach him a lesson." )
the_princess_bride = Movie.create(title: 'The Princess Bride', description: "Buttercup, a princess, is madly in love with a farm boy, Westley. Unfortunately, things take a turn in their lives when Westley goes out in search of employment and gets attacked by a pirate.")
arrival = Movie.create(title: 'Arrival', description: "Louise Banks, a linguistics expert, along with her team, must interpret the language of aliens who have come to Earth in a mysterious spaceship.")
night_crawler = Movie.create(title: 'Night Crawler', description:"Louis Bloom, a petty thief, realises that he can make money by capturing photographs of crime scenes and starts resorting to extreme tactics to get them.")
butterfly_effect = Movie.create(title: 'The Butterfly Effect', description: "Evan gets severe headaches that cause him to suffer blackouts. While unconscious, he is able to travel back in time and alter the past but this causes drastic changes in his present life.")
inception = Movie.create(title: 'Inception', description: "A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O., but his tragic past may doom the project and his team to disaster.")
lovebirds = Movie.create(title: 'Lovebirds', description: "A fizzling romance. A shocking crime. A ridiculous plan. They can't even figure out their relationship. How can they solve a murder?")
pretty_woman = Movie.create(title: 'Pretty Woman', description: "A man in a legal but hurtful business needs an escort for some social events, and hires a beautiful prostitute he meets... only to fall in love.")
footloose = Movie.create(title: 'Footloose', description:"A city teenager moves to a small town where rock music and dancing have been banned, and his rebellious spirit shakes up the populace.")
breakfast_club = Movie.create(title: 'The Breakfast Club', description: "Five high school students meet in Saturday detention and discover how they have a lot more in common than they thought.")
dangerous_liaisons = Movie.create(title: 'Dangerous Liaisons', description:"A scheming widow and her manipulative ex-lover make a bet regarding the corruption of a recently married woman.")
